  ...
  return (
    <div className="w-[1280px] h-[720px] bg-white p-12 font-sans flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10">
        ...
        >
          <div className="w-48 h-48 rounded-2xl overflow-hidden shadow-xl hover:scale-105 transition-transform duration-300 cursor-pointer hover:shadow-2xl">
            <img
              src="/4buddies-logo.webp"
              alt="4BUDDIES Logo"
        ...
        {/* Title - animated */}
        <h1
          className={`text-5xl font-bold text-[#1A1A1A] tracking-tight mb-2 text-center transition-all duration-700 ${
            isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
          style={{ transitionDelay: "400ms" }}
        >
          4BUDDIES <span className="text-[#F7B500] animate-pulse-slow">+</span> FDA
        </h1>
